...
namespace hh
{
	...
	public:
		...
		bool next()
		{
			return next_ancestry(nullptr);
		}  // ret: success
		bool prev();                                    // ret: success; die if !_pmrs.is_reversible()
		bool goto_nvertices(int nv)
		{
			return goto_nvertices_ancestry(nv, nullptr);
		}  // ret: success
		bool goto_nfaces(int nf)
		{
			return goto_nfaces_ancestry(nf, nullptr);
		}        // within +- 1, favor 0 or -1

...
namespace hh
{
	...
	public:
		...
		friend Vector4i operator-(const Vector4i& l)
		{
			return Vector4i(0) - l;
		}
		...
		{
			_r = _mm_loadu_si128(reinterpret_cast<const __m128i*>(pSrc));
		}
		void store_unaligned(int* pDst) const
		{
			_mm_storeu_si128(reinterpret_cast<__m128i*>(pDst), _r);
		}
		void load_aligned(const int* pSrc)
		{
			_r = _mm_load_si128(reinterpret_cast<const __m128i*>(pSrc));
		}
		void store_aligned(int* pDst) const
		{
			_mm_store_si128(reinterpret_cast<__m128i*>(pDst), _r);
		}
		friend Vector4i operator+(const Vector4i& l, const Vector4i& r)
		{
			return _mm_add_epi32(l._r, r._r);
		}
		friend Vector4i operator-(const Vector4i& l, const Vector4i& r)
		{
			return _mm_sub_epi32(l._r, r._r);
		}
		friend Vector4i operator*(const Vector4i& l, const Vector4i& r)
		{
#if defined(HH_NO_SSE41)
		...
		{
			return _mm_add_epi32(v._r, _mm_set1_epi32(i));
		}
		friend Vector4i operator-(const Vector4i& v, int i)
		{
			return _mm_sub_epi32(v._r, _mm_set1_epi32(i));
		}
		friend Vector4i operator*(const Vector4i& v, int i)
		{
#if defined(HH_NO_SSE41)
		...
		friend Vector4i min(const Vector4i& l, const Vector4i& r)
		{
			return _mm_min_epi32(l._r, r._r);
		}
		friend Vector4i max(const Vector4i& l, const Vector4i& r)
		{
			return _mm_max_epi32(l._r, r._r);
		}
#endif
		friend Vector4i operator&(const Vector4i& l, const Vector4i& r)
		{
			return _mm_and_si128(l._r, r._r);
		}
		friend Vector4i operator|(const Vector4i& l, const Vector4i& r)
		{
			return _mm_or_si128(l._r, r._r);
		}
		friend Vector4i operator^(const Vector4i& l, const Vector4i& r)
		{
			return _mm_xor_si128(l._r, r._r);
		}
		friend Vector4i operator<<(const Vector4i& l, int n)
		{
			return _mm_slli_epi32(l._r, n);
		}
		friend Vector4i operator>>(const Vector4i& l, int n)
		{
			return _mm_srai_epi32(l._r, n);
		}
#if defined(HH_NO_SSE41)
	...
	private:
		...
		friend Vector4i operator<<(const Vector4i& l, int n)
		{
			return Vector4i(l[0] << n, l[1] << n, l[2] << n, l[3] << n);
		}
		friend Vector4i operator>>(const Vector4i& l, int n)
		{
			return Vector4i(l[0] >> n, l[1] >> n, l[2] >> n, l[3] >> n);
	...
	Vector4i operator>>(const Vector4i& l, int n);
	inline Vector4i operator*(int i, const Vector4i& v)
	{
		return v * i;
	}
	inline Vector4i& operator+=(Vector4i& l, const Vector4i& r)
	{
		return l = l + r;
	}
	inline Vector4i& operator-=(Vector4i& l, const Vector4i& r)
	...
	inline Vector4i& operator+=(Vector4i& l, int i)
	{
		return l = l + i;
	}
	inline Vector4i& operator-=(Vector4i& l, int i)
	...
	template <> inline void my_zero(Vector4i& v)
	{
		v = Vector4i(0);
	}
